...
export default function Home() {
  ...
  const [time, setTime] = useState<{ dias: string | number, horas: string | number, minutos: string | number, segundos: string | number }>({ dias: 10, horas: 10, minutos: 10, segundos: 0 })
  ...
  return (
    <main className='w-full'>
      <div className='m-auto w-11/12 md:w-9/12 translate-y-40 md:translate-y-32 lg:translate-y-32 xl:translate-y-44'>
        ...
        <p className='text-center text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-white font-semibold mb-2 xl:mb-4 drop-shadow-lg'>{time.dias}d {time.horas}h {time.minutos}m {time.segundos}s</p>
